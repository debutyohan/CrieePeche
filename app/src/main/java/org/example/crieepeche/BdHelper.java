...
public class BdHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {;
        ...
        db.execSQL(req);
        req = "insert into Bac values(1,'29/04/2022', 34150, 'ENT', 'B');";
        db.execSQL(req);
        req = "insert into Bac values(2,'29/04/2022', 37050, 'VID', 'F');";
        db.execSQL(req);
        req = "insert into Bac values(3,'29/04/2022', 33730, 'ET', 'B');";
        db.execSQL(req);
        req = "insert into Bac values(4,'29/04/2022', 33730, 'VID', 'B');";
        db.execSQL(req);
        req = "insert into Bac values(5,'29/04/2022', 33500, 'VID', 'F');";
        db.execSQL(req);
