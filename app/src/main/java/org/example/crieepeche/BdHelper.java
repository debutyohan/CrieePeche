...
public class BdHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {;
        ...
        db.execSQL(req);
        req = "insert into Bac values(1,'01/05/2022', 34150, 'ENT', 'B');";
        db.execSQL(req);
        req = "insert into Bac values(2,'01/05/2022', 37050, 'VID', 'F');";
        db.execSQL(req);
        req = "insert into Bac values(3,'01/05/2022', 33730, 'ET', 'B');";
        db.execSQL(req);
        req = "insert into Bac values(4,'01/05/2022', 33730, 'VID', 'B');";
        db.execSQL(req);
        req = "insert into Bac values(5,'01/05/2022', 33500, 'VID', 'F');";
        db.execSQL(req);
