...
ALTER TABLE Utilisateur ADD COLUMN dateinsert DATETIME NULL DEFAULT NOW();
ALTER TABLE Utilisateur ADD COLUMN datemodif DATETIME NULL DEFAULT NOW();
UPDATE Utilisateur INNER JOIN Acheteur SET Utilisateur.dateinsert=Acheteur.dateinsert, Utilisateur.datemodif=Acheteur.datemodif  WHERE idtypeuser=5 AND Utilisateur.id=Acheteur.id;
ALTER TABLE Acheteur DROP COLUMN dateinsert;
ALTER TABLE Acheteur DROP COLUMN datemodif;
